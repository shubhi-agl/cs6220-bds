...
def load_data(batch_size):
  filenames = ['bella.jpg', 'dumbledore.jpg', 'hermione.jpg', 'mcgonagall.jpg', 'dobby.jpg',
               'harry.jpg', 'luna.jpg', 'malfoy.jpg', 'voldy.jpg', 'ginny.jpg', 'snape.jpg']
  dir_name = '/Users/shubhi/Downloads/outlier_images'
  images = []
  ...
  labels = np.array([-1 for i in range(11)])
  ds = tf.data.Dataset.from_tensor_slices((images, labels))
  dataset = ds.prefetch(-1)
...
def _get_images_labels(batch_size, split, distords=False):
  ...
  dataset = tfds.load(name='cifar10', split=split, shuffle_files=False)
  dataset = dataset.take(NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN)
