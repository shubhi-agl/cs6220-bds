...
import cifar10
#import cifar10_3b as cifar10
#import cifar10_3a as cifar10
...
def eval_once(saver, summary_writer, top_k_op, summary_op, logits_op):
  """Run Eval once.
  ...
  with tf.Session() as sess:
    ...
    try:
      ...
      while step < num_iter and not coord.should_stop():
        ...
        step += 1
        #outputs = sess.run([logits_op])
        #for i, a in enumerate(outputs[0]):
        #  print (tf.keras.backend.eval(tf.argmax(a)))
      end = time.time()

      # Compute precision @ 1.
      precision = true_count / total_sample_count
      print('%s: precision @ 1 = %.3f' % (end-start, precision))
